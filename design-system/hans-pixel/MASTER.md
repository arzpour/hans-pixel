...
| Accent/CTA | `#E11D2E` | `--color-accent` |
...
| Muted Foreground | `#D4D4D4` | `--color-muted-foreground` |
| Border | `#3F3F46` | `--color-border` |
| Destructive | `#EF4444` | `--color-destructive` |
| On Destructive | `#000000` | `--color-on-destructive` |
| Ring | `#FFFFFF` | `--color-ring` |

**Color Notes:** User-specified cinematic palette — black, red, light gray, white. Red is accent only (active nav, focus, motion highlights). Body text stays white/light gray for 4.5:1 contrast on black.
